...
declare-option str bright_bg 'rgb:084b26'
declare-option str bright_alt_bg 'rgb:664759'
declare-option str fg 'rgb:c7f7ef'
declare-option str alt_fg 'rgb:f7c7d9'
declare-option str dim_fg 'rgb:20593a'
declare-option str red 'rgb:f31039'
declare-option str bright_blue 'rgb:a9fba6'
declare-option str dim_blue 'rgb:20593a'
declare-option str blue 'rgb:63ad85'
declare-option str orange 'rgb:ff2087'
declare-option str pale_orange 'rgb:f864b9'
declare-option str bright_orange 'rgb:ff0076'
declare-option str dark_orange 'rgb:7d3042'
...
declare-option str green 'rgb:0000bb'
declare-option str dim_bright_orange 'rgb:ffdef6'
declare-option str mustard 'rgb:ff00c4'
